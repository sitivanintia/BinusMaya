...
class Api {
    ...
    static String post(String url, String json) throws Exception {
        ...
        c.setInstanceFollowRedirects(false); c.setConnectTimeout(15000); c.setReadTimeout(25000);
        ...
        for (int hop = 0; hop < 3 && (code == 301 || code == 302 || code == 303 || code == 307); hop++) {
            ...
            c = (HttpURLConnection) new URL(loc).openConnection(); c.setInstanceFollowRedirects(false); c.setConnectTimeout(15000); c.setReadTimeout(25000);
