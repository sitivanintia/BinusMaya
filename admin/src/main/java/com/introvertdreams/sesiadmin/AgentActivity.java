...
public class AgentActivity extends AppCompatActivity {
    static final int BG = AdminActivity.BG, CARD = AdminActivity.CARD, TEXT = AdminActivity.TEXT, TEXT2 = AdminActivity.TEXT2, GREEN = AdminActivity.GREEN, ORANGE = AdminActivity.ORANGE, RED = AdminActivity.RED, SILVER = AdminActivity.SILVER;
    SharedPreferences prefs;
    LinearLayout chat, drafts, reports; ScrollView chatScroll; EditText input; Button send; TextView modelLabel, status;
    boolean busy; JSONArray messages = new JSONArray(); int tab = 0; LinearLayout[] panes = new LinearLayout[3]; TextView[] tabs = new TextView[3];
    ...
    @Override protected void onCreate(Bundle b) {
        ...
        build(); loadConfig(); renderChat(); loadDrafts(); loadReports();
    }
    ...
    void build() {
        ...
        tcol.addView(tv("AI Agent", 20, TEXT, true)); modelLabel = tv("model belum dipilih", 11, TEXT2, false); tcol.addView(modelLabel);
